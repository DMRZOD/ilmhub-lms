      ...
      <header className="flex flex-col gap-sp-3 sm:flex-row sm:items-end sm:justify-between">
        <div className="flex flex-col gap-sp-2">
          ...
          <p className="text-t-14 text-fg-2">
            Kurslar, sharhlar va yutuqlardagi yangiliklar.
          </p>
        </div>
        <Button
          variant="secondary"
    ...
    >
      ...
      <div className="min-w-0 flex flex-1 flex-col gap-1">
        <div className="flex items-baseline justify-between gap-sp-2">
          <span
            className={cn(
              "truncate text-t-14 text-ilm-ink",
      ...
      {unread && (
        <span
          ...
          className="mt-2 h-2 w-2 shrink-0 rounded-full bg-ilm-ink"
        />
      )}
    </button>
  );
  ...
  return (
    <div className="flex flex-col items-center gap-sp-4 py-sp-16 text-center">
      ...
      <p className="max-w-md text-t-14 text-fg-2">
        Yangi xabarlar mana shu yerda paydo bo&apos;ladi.
      </p>
    </div>
  );
}
