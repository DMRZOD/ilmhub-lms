...
const STORAGE_KEY = "ilm:instructor-sidebar:collapsed";
  ...
  return (
    ...
    >
        ...
        >
          {collapsed ? (
            ...
            <>
              ...
              />
              <span className="text-t-12 text-white/60">Ustoz paneli</span>
            </>
          )}
        </Link>
        {toggle}
      ...
      <div className="flex-1 overflow-y-auto px-3">
        <SidebarNav items={INSTRUCTOR_NAV_ITEMS} collapsed={collapsed} />
      </div>
    </aside>
  );
}
